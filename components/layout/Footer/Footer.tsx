		...
		<footer className='bg-neutral-light-100 mt-48 pt-22 pb-6'>
			<div className='container mx-auto flex flex-col'>
				...
				<div className='text-center mt-30 w-full'>
					<Text className='relative before:absolute before:left-0 before:w-full before:h-px before:top-0 before:bg-neutral-light-200 before:-mt-6'>
